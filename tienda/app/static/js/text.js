            ...
            function init(att) {
                ...
                (function main() {
                    ...
                    cart.addEventListener("click", function (e) {
                        ...
                        for (var key in listeners) {
                            if (listeners.hasOwnProperty(key) && e.target && e.target.matches(
                                key)) {
                ...
                function createProductBox(data) {
                    var template = '<div class="quick-cart-product-wrap">' +
                        '<img src="' + data.image + '">' +
                        '<span class=" s1" style="background-color: ' + data.color + '; opacity: .5">' + data
                        .price.trim() + '</span>' +
                        ...
                        '<span class="quick-cart-product-removeall removeall" data-id="' + data.id +
                        '"></span>';
                ...
                function fallbackAnimation(element, c) {
                    ...
                    animate({
                        ...
                        run: function (t) {
                            ...
                            var trans = "translate(" + Math.round(curpos.x) + "px," + Math.round(
                                curpos.y) + "px)";
                ...
                function createAnimatedObject(data) {
                    ...
                    var template = '<div style="width:' + width + 'px; height:' + height + 'px;">' +
                        '<img src="' + imageUrl + '">' +
                        '<span class="s1" style="background-color: ' + color +
                ...
                function getAnimationCoordinations(element) {
                    ...
                    var final = document.querySelector("#quick-cart-product-" + variantId)
                ...
                function setPayButtonAction() {
                    if (cartPay) {
                        ...
                        var window_w = window.innerWidth || document.documentElement.clientWidth || document
                            .body.clientWidth;
